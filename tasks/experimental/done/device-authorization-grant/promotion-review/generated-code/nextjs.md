# 生成コード差分: device-authorization-grant — nextjs
...
| 種別 | ファイル |
|---|---|
| 追加 | _oidc-provider/routes/device-authorization.ts, _oidc-provider/routes/device.ts, device/approve/route.ts, device/login/route.ts, device/route.ts, device_authorization/route.ts |
| 変更 | _oidc-provider/app.ts, _oidc-provider/conformance.test.ts, _oidc-provider/routes/discovery.ts, _oidc-provider/routes/token.ts, _oidc-provider/store.ts, _oidc-provider/views.ts |
| 削除 | （なし） |
...
--- /dev/null
+++ b/with-device-authorization-grant/_oidc-provider/routes/device-authorization.ts
@@ -0,0 +1,187 @@
+/**
...
+  }
+});
diff --git a/with-device-authorization-grant/_oidc-provider/routes/device.ts b/with-device-authorization-grant/_oidc-provider/routes/device.ts
new file mode 100644
index 0000000..a962647
--- /dev/null
+++ b/with-device-authorization-grant/_oidc-provider/routes/device.ts
@@ -0,0 +1,325 @@
+/**
...
+import { deviceAuthorizationConfig } from './device-authorization';
+
...
+  }
+});
diff --git a/default-op/_oidc-provider/routes/discovery.ts b/with-device-authorization-grant/_oidc-provider/routes/discovery.ts
index 6561812..dfdf0f5 100644
--- a/default-op/_oidc-provider/routes/discovery.ts
+++ b/with-device-authorization-grant/_oidc-provider/routes/discovery.ts
...
+  deviceCompletedPage: defaultDeviceCompletedPage,
 ...
 /**
diff --git a/with-device-authorization-grant/device/approve/route.ts b/with-device-authorization-grant/device/approve/route.ts
new file mode 100644
index 0000000..123134e
--- /dev/null
+++ b/with-device-authorization-grant/device/approve/route.ts
@@ -0,0 +1,6 @@
...
diff --git a/with-device-authorization-grant/device/login/route.ts b/with-device-authorization-grant/device/login/route.ts
new file mode 100644
index 0000000..123134e
--- /dev/null
+++ b/with-device-authorization-grant/device/login/route.ts
@@ -0,0 +1,6 @@
+import { oidcHandlers } from '../../_oidc-provider/runtime';
+
+export const dynamic = 'force-dynamic';
...
+
+export const POST = oidcHandlers.POST;
diff --git a/with-device-authorization-grant/device/route.ts b/with-device-authorization-grant/device/route.ts
new file mode 100644
index 0000000..5dd5905
--- /dev/null
+++ b/with-device-authorization-grant/device/route.ts
@@ -0,0 +1,7 @@
+import { oidcHandlers } from '../_oidc-provider/runtime';
+
+export const dynamic = 'force-dynamic';
...
+export const POST = oidcHandlers.POST;
diff --git a/with-device-authorization-grant/device_authorization/route.ts b/with-device-authorization-grant/device_authorization/route.ts
new file mode 100644
index 0000000..312e3b8
--- /dev/null
+++ b/with-device-authorization-grant/device_authorization/route.ts
@@ -0,0 +1,7 @@
+import { oidcHandlers } from '../_oidc-provider/runtime';
+
+export const dynamic = 'force-dynamic';

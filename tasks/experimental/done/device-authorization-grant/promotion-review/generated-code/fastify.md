# 生成コード差分: device-authorization-grant — fastify
...
index 38e8944..5fb7ac8 100644
--- a/default-op/apply.ts
+++ b/with-device-authorization-grant/apply.ts
@@ -35,6 +35,10 @@ export async function applyOidc(app: FastifyInstance, options: ApplyOidcOptions)

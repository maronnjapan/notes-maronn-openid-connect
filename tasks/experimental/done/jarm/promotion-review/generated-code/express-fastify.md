...
index 75a5580..ff7d2c9 100644
--- a/default-op/conformance.test.ts
+++ b/with-jarm/conformance.test.ts
@@ -423,10 +423,11 @@ describe('generated provider HTTP conformance', () => {
...
@@ -2514,6 +2515,407 @@ describe('generated provider HTTP conformance', () => {
     });
   });

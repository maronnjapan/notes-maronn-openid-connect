...
> **このディレクトリは `pnpm review:experimental par` が生成した機械生成物です。**
> `decision.md` 以外はツールが再生成のたびに作り直します。手で編集しないでください。

experimental 機能 `par` を experimental から外してよいか（昇格させてよいか）を、
...
- [tasks/experimental/done/par/specification.md](../../../../../tasks/experimental/done/par/specification.md)
- [tasks/experimental/done/par/understanding-guide.md](../../../../../tasks/experimental/done/par/understanding-guide.md)
- [tasks/experimental/done/par/sources.md](../../../../../tasks/experimental/done/par/sources.md)
- [tasks/experimental/done/par/review-log.md](../../../../../tasks/experimental/done/par/review-log.md)
- [tasks/experimental/done/par/state.yaml](../../../../../tasks/experimental/done/par/state.yaml)

## 1. この機能を構成するコードの地図

### 1.1 experimental パッケージ本体（ロジック層）

実装（[packages/experimental/src/par](../../../../../packages/experimental/src/par)）:

| ファイル | 行数 |
|---|---|
| [packages/experimental/src/par/index.ts](../../../../../packages/experimental/src/par/index.ts) | 35 |
| [packages/experimental/src/par/par-request.ts](../../../../../packages/experimental/src/par/par-request.ts) | 386 |
| [packages/experimental/src/par/resolve-request-uri.ts](../../../../../packages/experimental/src/par/resolve-request-uri.ts) | 107 |
| [packages/experimental/src/par/store.ts](../../../../../packages/experimental/src/par/store.ts) | 54 |

単体テスト:

| ファイル | 行数 |
|---|---|
| [packages/experimental/src/par/par-request.test.ts](../../../../../packages/experimental/src/par/par-request.test.ts) | 556 |
| [packages/experimental/src/par/resolve-request-uri.test.ts](../../../../../packages/experimental/src/par/resolve-request-uri.test.ts) | 321 |

### 1.2 CLI 統合（コード生成側）

`packages/cli` 内で `par` に言及しているファイル（言及回数は機械カウント）:
...
`--enable par`（= `with-par`）を足したときに生成コードへ入る差分だけを、
フレームワークごとに機械的に切り出したものです。**他機能のコードは一切混ざっていません。**

| フレームワーク | 差分ドキュメント | 追加 | 変更 | 削除 | 規模 |
|---|---|---|---|---|---|
| hono | [generated-code/hono.md](./generated-code/hono.md) | 1 | 6 | 0 | +706 / -1 |
| express | [generated-code/express.md](./generated-code/express.md) | 1 | 6 | 0 | +700 / -1 |
| fastify | [generated-code/fastify.md](./generated-code/fastify.md) | 1 | 6 | 0 | +700 / -1 |
| nextjs | [generated-code/nextjs.md](./generated-code/nextjs.md) | 2 | 5 | 0 | +706 / -1 |

差分に **現れない** 生成ファイル（この機能のレビューでは読む必要がないもの）:

- hono: config.ts, resolvers.ts, routes/consent.ts, routes/introspection.ts, routes/jwks.ts, routes/login.ts, routes/revocation.ts, routes/token.ts, routes/userinfo.ts, views.ts
- express: config.ts, node-adapter.ts, resolvers.ts, routes/consent.ts, routes/introspection.ts, routes/jwks.ts, routes/login.ts, routes/revocation.ts, routes/token.ts, routes/userinfo.ts, views.ts, web-router.ts
- fastify: config.ts, node-adapter.ts, resolvers.ts, routes/consent.ts, routes/introspection.ts, routes/jwks.ts, routes/login.ts, routes/revocation.ts, routes/token.ts, routes/userinfo.ts, views.ts, web-router.ts
- nextjs: .well-known/jwks.json/route.ts, .well-known/openid-configuration/route.ts, _oidc-provider/config.ts, _oidc-provider/next.ts, _oidc-provider/resolvers.ts, _oidc-provider/routes/consent.ts, _oidc-provider/routes/introspection.ts, _oidc-provider/routes/jwks.ts, _oidc-provider/routes/login.ts, _oidc-provider/routes/revocation.ts, _oidc-provider/routes/token.ts, _oidc-provider/routes/userinfo.ts, _oidc-provider/runtime.ts, _oidc-provider/storage-backend.ts, _oidc-provider/views.ts, _oidc-provider/web-router.ts, authorize/route.ts, consent/actions.ts, consent/page.tsx, introspect/route.ts, login/actions.ts, login/page.tsx, oidc-error/error.tsx, oidc-error/page.tsx, revoke/route.ts, token/route.ts, userinfo/route.ts
...
| ファイル | 言及回数 |
|---|---|
| [tests/e2e/apps/client.mjs](../../../../../tests/e2e/apps/client.mjs) | 2 |
| [tests/e2e/specs/pushed-authorization-requests.spec.ts](../../../../../tests/e2e/specs/pushed-authorization-requests.spec.ts) | 20 |
...
| ファイル | 言及回数 |
|---|---|
| [docs/library-document/src/content/docs/experimental/index.md](../../../../../docs/library-document/src/content/docs/experimental/index.md) | 6 |
| [docs/library-document/src/content/docs/experimental/jarm.md](../../../../../docs/library-document/src/content/docs/experimental/jarm.md) | 1 |
| [docs/library-document/src/content/docs/experimental/par.md](../../../../../docs/library-document/src/content/docs/experimental/par.md) | 43 |
| [docs/library-document/src/content/docs/experimental/token-exchange.md](../../../../../docs/library-document/src/content/docs/experimental/token-exchange.md) | 2 |
| [docs/library-document/src/content/docs/guides/cli.md](../../../../../docs/library-document/src/content/docs/guides/cli.md) | 3 |
| [packages/experimental/README.md](../../../../../packages/experimental/README.md) | 4 |
...
`pnpm review:experimental par --check` が失敗する場合、パケット生成後に実装が変わっています。

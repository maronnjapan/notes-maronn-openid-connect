...
|---|---|
| 追加 | routes/par.ts |
| 変更 | app.ts, apply.ts, conformance.test.ts, routes/authorize.ts, routes/discovery.ts, store.ts |
| 削除 | （なし） |
...
index 430b0f1..4406c4a 100644
--- a/default-op/app.ts
+++ b/with-par/app.ts
@@ -4,6 +4,7 @@ import { tokenApp } from './routes/token.js';
...
index 38e8944..8480898 100644
--- a/default-op/apply.ts
+++ b/with-par/apply.ts
@@ -35,6 +35,7 @@ export async function applyOidc(app: FastifyInstance, options: ApplyOidcOptions)
...
@@ -2459,6 +2461,416 @@ describe('generated provider HTTP conformance', () => {
   });

...
@@ -137,6 +138,26 @@ const testClients = new Map<string, RegisteredClient>([
...
@@ -2474,6 +2495,690 @@ describe('generated provider HTTP conformance', () => {
   });
